...
public static class StorageService
{
    ...
    public static string DirectoryBase { get; set; }
    //{
    //    get
    //    {
    //        if (String.IsNullOrEmpty(directoryBase))
    //        {
    //            directoryBase = "Sample";
    ...
    public static async Task<byte[]> LoadBytesAsync(string res)
    {
        using var stream = await DeviceServices.Core.LoadFileAsync(res);
